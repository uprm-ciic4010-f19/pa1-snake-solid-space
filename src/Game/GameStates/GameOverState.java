	...
	public void render(Graphics g) {
		...
		if (singleplayer) {
			...
			if (!Player.playerOneLost) {
				...
				g.setColor(Color.BLACK);
				g.fillRect(ScreenRes.GridPixelsize*GameState.boardLocationStartX, 0, ScreenRes.GridPixelsize*GameState.boardLocationEndX, ScreenRes.height);
				g.setColor(GO);
				...
				g.setColor(Color.BLACK);
				g.fillRect(0, 0, ScreenRes.GridPixelsize*GameState.boardLocationEndX, ScreenRes.height);
				g.setColor(GO);
				g.setFont(new Font("arial", Font.PLAIN, 80 / ScreenRes.downscale));
